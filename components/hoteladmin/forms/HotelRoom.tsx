...
function HotelRoomForm({ submitHandler, loading, formMethods }: IProps) {
  const {
    control,
    register,
    formState: { errors },
    ...
    <form onSubmit={handleSubmit(submitHandler)}>
      ...
      <div className="row my-3">
        ...
        <div className="col-md-4 form-group">
          ...
          <input
            {...register("king_bed", {
              required: "King Bed number is required!",
            })}
          ...
          {errors?.king_bed?.message && (
            <div className="text-danger">{errors?.king_bed?.message + ""}</div>
          )}
        </div>
        <div className="col-md-4 form-group">
          ...
          <input
            {...register("queen_bed", {
              required: "Queen Bed number is required!",
            })}
          ...
          {errors?.queen_bed?.message && (
            <div className="text-danger">{errors?.queen_bed?.message + ""}</div>
          )}
        </div>
        <div className="mt-3 col-md-4 form-group">
          ...
          {errors?.twin_bed?.message && (
            <div className="text-danger">{errors?.twin_bed?.message + ""}</div>
          )}
        </div>
        <div className="mt-3 col-md-4 form-group">
        ...
        <div className="mt-3 col-md-4 form-group">
          ...
          {errors?.full_bed?.message && (
            <div className="text-danger">{errors?.full_bed?.message + ""}</div>
          )}
        </div>
      </div>
      {/* row 5 */}
      <div className="form-group mb-3">
        <label className="form-label">
          included_excluded<span className="text-danger"> *</span>
        </label>
        <Controller
          control={control}
          name="included_excluded"
          rules={{ required: "included_excluded facilities are required!" }}
          render={({ field: { onChange, value = null } }) => (
            <>
              <div
                className="wysiwyg-wrapper"
                aria-invalid={!!errors["included_excluded"]?.message}
              >
                {rtfChanged ? (
                  <Editor
                    // @ts-ignore
