...
const ContextComponent = ({ selectedRoom, bookingDate, people }: any) => {
        ...
        if (paymentMethodId == "esewa") {
          ...
          axios
            .post(
              ...
              {
                return_url:
                  "https://api.eakaksha.com/hotel/khalti/verifyHotelPayment",
  ...
  const dateDiff = moment(bookingDate[1]).diff(bookingDate[0], "days");
    ...
    <div className="contextmenu_wrapper">
      <div className="context_room_detail" style={{ fontSize: "14px" }}>
        ...
        <span style={{ fontSize: "16px" }}>
          <strong>
            NPR {selectedPrice} * {dateDiff} days = NPR{" "}
            {selectedPrice * dateDiff}
          </strong>
        </span>
      </div>
