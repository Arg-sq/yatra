            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="vendor_form_heading">
                  ...
                  <p>
                    Submit your hotel application here and get your hotel listed
                    on <b>YatraSamaya</b>.
                  </p>
                </div>
              </div>
            ...
            <div className="form-group">
              <div className="form-group mb-3">
                <input
                  ...
                  aria-invalid={!!errors?.stay_name?.message}
                  {...register("stay_name", {
                    required: "Hotel Name is Required",
                  })}
                />
                {errors?.stay_name?.message && (
          ...
          <div className="col-lg-6">
            <div className="form-group mb-3">
              <input
                ...
                className="mb-0 form-control bg_input"
                aria-invalid={!!errors?.applicant_full_name?.message}
                {...register("applicant_full_name", {
                  required: "Admin Name is Required",
                })}
              />
              {errors?.applicant_full_name?.message && (
                <div className="text-danger">
                  {errors?.applicant_full_name?.message + ""}
                </div>
              )}
            ...
            <div className="form-group">
              <div className="form-group mb-3">
                <input
                  placeholder="Email"
                  className="mb-0 form-control bg_input"
                  aria-invalid={!!errors?.applicant_email?.message}
          ...
          <div className="col-lg-6">
            <div className="form-group mb-3">
              <input
                ...
                className="mb-0 form-control bg_input"
                aria-invalid={!!errors?.mobile_number?.message}
          ...
          <div className="col-lg-4">
            <div className="form-group mb-3">
              <input
                ...
                className="mb-0 form-control bg_input"
                aria-invalid={!!errors?.state?.message}
                {...register("state", {
